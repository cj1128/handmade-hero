...
REM 64-bit build
del *.pdb > NUL 2> NUL
cl %CommonCompilerFlags% ..\work\code\handmade.cpp -Fmhandmade.map /LD /link %CommonLinkerFlags% -PDB:handmade_%random%.pdb -EXPORT:GameUpdateAudio -EXPORT:GameUpdateVideo
